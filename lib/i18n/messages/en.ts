...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "files.delete": "Delete",
    "files.deleteFileConfirm": "Move \"{name}\" to the trash?",
    "files.deleteDirConfirm": "Move directory \"{name}\" and everything inside it to the trash?",
    "files.deletePermanently": "Permanently delete from disk (cannot be undone)",
